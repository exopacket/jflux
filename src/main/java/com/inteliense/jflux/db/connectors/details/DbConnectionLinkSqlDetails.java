...
public class DbConnectionLinkSqlDetails extends DbConnectionDetails {
    ...
    public DbConnectionLinkSqlDetails(String name, String host, int port, String username, String password) {
        super(DbType.MYSQL);
        this.name = name;
        this.host = host;
        this.port = port;
